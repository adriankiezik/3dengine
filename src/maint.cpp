...
//     unsigned char *data =
//         stbi_load("../resources/wall.jpg", &width, &height, &nrChannels, 0);
...
//         glm::mat4 projection;
//         projection = glm::perspective(glm::radians(80.0f), 800.0f / 600.0f,
//                                       0.1f, 100.0f);

//         shader.setUniformMatrix4fv("model", 1, GL_FALSE,
//                                    glm::value_ptr(model));
//         shader.setUniformMatrix4fv("view", 1, GL_FALSE, &view[0][0]);
